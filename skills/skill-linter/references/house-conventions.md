...
- A `*.skill` bundle whose name does not match the skill id. Bundles are
  generated by `scripts/bundle.py` and shipped for the Claude.ai upload path;
  a mismatched name means a rename left an artifact behind.
