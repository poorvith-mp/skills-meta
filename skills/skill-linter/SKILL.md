...
- The `*.skill` bundle, if present, must be named for the skill. Bundles are generated by `scripts/bundle.py`; a mismatched name means a rename left an artifact behind.
